...
# ==========================================
# Arahkan ke folder test (sesuai struktur plan.txt aslimu)
...
# ==========================================
print("\nMemuat model densenet121_best.keras...")
model = tf.keras.models.load_model('densenet121_best.keras')
...
# Mencetak hasil (Indeks 0 biasanya loss, sisanya adalah metrics yang kita define di main.py)
...
# 5.2 Melakukan prediksi (menghasilkan angka probabilitas dari sigmoid, e.g., 0.89 atau 0.12)
...
plt.title('Confusion Matrix - Uji Coba DenseNet121 - B', fontsize=16)
plt.ylabel('Label Asli (True Label)', fontsize=12)
plt.xlabel('Prediksi Model (Predicted Label)', fontsize=12)
plt.tight_layout()

# Menyimpan gambar
save_path = 'confusion_matrix_densenet121_B.png'
